...
function Sidebar({ activeModule, onModuleChange }: SidebarProps) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: '/attendance',
      subItems: [
        { id: 'attendance-dashboard', label: 'لوحة الحضور', path: '/attendance' },
        { id: 'attendance-records', label: 'سجلات الحضور', path: '/attendance/records' },
        { id: 'attendance-reports', label: 'تقارير الحضور', path: '/attendance/reports' }
      ]
    },
    {
      id: 'reports',
